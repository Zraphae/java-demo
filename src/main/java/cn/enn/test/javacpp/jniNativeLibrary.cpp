// Generated by JavaCPP version 1.4: DO NOT EDIT THIS FILE
...
static const char* JavaCPP_classNames[9] = {
        ...
        "java/nio/Buffer",
        "java/lang/Object",
        "cn/enn/test/javacpp/NativeLibrary$NativeClass",
...
static void JavaCPP_cn_enn_test_javacpp_NativeLibrary_00024NativeClass_deallocate(void *p) { delete (NativeLibrary::NativeClass*)p; }

static const char* JavaCPP_members[9][21] = {
        { NULL },
        { NULL },
        { NULL },
        { NULL },
        ...
        { NULL },
        { NULL } };
static int JavaCPP_offsets[9][21] = {
        { -1 },
        { -1 },
        { -1 },
        { -1 },
        ...
        { -1 },
        { -1 } };
static int JavaCPP_memberOffsetSizes[9] = { 1, 1, 1, 1, 1, 1, 2, 1, 1 };
...
JNIEXPORT void JNICALL Java_cn_enn_test_javacpp_NativeLibrary_00024NativeClass_allocate(JNIEnv* env, jobject obj) {
    jthrowable exc = NULL;
    try {
        NativeLibrary::NativeClass* rptr = new NativeLibrary::NativeClass();
        jlong rcapacity = 1;
        JavaCPP_initPointer(env, obj, rptr, rcapacity, rptr, &JavaCPP_cn_enn_test_javacpp_NativeLibrary_00024NativeClass_deallocate);
    } catch (...) {
...
JNIEXPORT jstring JNICALL Java_cn_enn_test_javacpp_NativeLibrary_00024NativeClass_property__(JNIEnv* env, jobject obj) {
    ...
    jstring rarg = NULL;
    const char* rptr;
    StringAdapter radapter(ptr->property);
    rptr = radapter;
    if (rptr != NULL) {
...
JNIEXPORT void JNICALL Java_cn_enn_test_javacpp_NativeLibrary_00024NativeClass_property__Ljava_lang_String_2(JNIEnv* env, jobject obj, jstring arg0) {
    NativeLibrary::NativeClass* ptr = (NativeLibrary::NativeClass*)jlong_to_ptr(env->GetLongField(obj, JavaCPP_addressFID));
    if (ptr == NULL) {
        env->ThrowNew(JavaCPP_getClass(env, 8), "This pointer address is NULL.");
        return;
    ...
    ptr->property = (std::string&)adapter0;
    JavaCPP_releaseStringBytes(env, arg0, ptr0);
}
JNIEXPORT void JNICALL Java_cn_enn_test_javacpp_NativeLibrary_00024NativeClass_set_1property(JNIEnv* env, jobject obj, jstring arg0) {
    NativeLibrary::NativeClass* ptr = (NativeLibrary::NativeClass*)jlong_to_ptr(env->GetLongField(obj, JavaCPP_addressFID));
    if (ptr == NULL) {
        env->ThrowNew(JavaCPP_getClass(env, 8), "This pointer address is NULL.");
        return;
...
JNIEXPORT jstring JNICALL Java_cn_enn_test_javacpp_NativeLibrary_00024NativeClass_get_1property(JNIEnv* env, jobject obj) {
    NativeLibrary::NativeClass* ptr = (NativeLibrary::NativeClass*)jlong_to_ptr(env->GetLongField(obj, JavaCPP_addressFID));
    if (ptr == NULL) {
        env->ThrowNew(JavaCPP_getClass(env, 8), "This pointer address is NULL.");
        return 0;
    ...
    jthrowable exc = NULL;
    try {
        StringAdapter radapter(ptr->get_property());
        rptr = radapter;
        if (rptr != NULL) {
            rarg = JavaCPP_createString(env, rptr);
        }
